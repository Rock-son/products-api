...
test("GET /api/products", async () => {
	const newProduct = await product.create({ name: "Product 1", price: 190, available: true }).save();
...
test("GET /api/product/:id", async () => {
	const newProduct = await product.create({ name: "Product 2", price: 290, available: true }).save();
...
test("DELETE /api/product/:id", async () => {
	const newProduct = await product.create({ name: "Product 4", price: 490, available: true }).save();
...
test("PUT /api/product", async () => {
	const newProduct = await product.create({ name: "Product 5", price: 590, available: true }).save();
